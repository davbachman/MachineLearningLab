...
import { batchGradientDescentNotebookLab, regularizationNotebookLab, logisticRegressionNotebookLab, softmaxNotebookLab } from '../../src/data/classificationCodeLabQuestions'

// Original answer keys for homework 7–10. Not exposed in the current app.
...
const batchGradientDescentAssignment = assignment({
...
const regularizationAssignment = assignment({
  id: 'regularization',
  displayNumber: 8,
...
const logisticRegressionAssignment = assignment({
...
const softmaxAssignment = assignment({
  id: 'softmax',
  displayNumber: 10,
  title: 'Softmax',
...
export const laterAssignmentsVersion1: Record<string, AssignmentSpec> = Object.fromEntries(
